...
export class News extends Component {
  ...
  async componentDidMount(){
    let url = `https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=0ccd349fa834435eaf497e217fa68f7c&page=1&pageSize=${this.props.pageSize}`;
    this.setState({
      loading:true
    })
  ...
  handlePrevClick = async () => {
      ...
      let url = `https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=0ccd349fa834435eaf497e217fa68f7c&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
      this.setState({
        loading:true
      })
    let data = await fetch(url);
